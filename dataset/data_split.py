...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--data", default="/home/sandwich/demo01_ws/FUnIE-GAN-PyTorch-master/FUnIE-GAN-PyTorch-master/images/Paired/underwater_scenes", type=str, metavar="PATH",
