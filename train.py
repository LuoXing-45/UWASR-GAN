...
from models import FUnIEDiscriminator,TotalGenLoss,CBAMGenerator
...
class Trainer(object):
    def __init__(self, arch, train_loader, valid_loader, lr, epochs, gen_resume, dis_resume, save_path, is_cuda):
        ...
        self.gen = {"cbam": CBAMGenerator}[arch]()
...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--arch", metavar="ARCH", default="cbam",
                        choices=model_names,
